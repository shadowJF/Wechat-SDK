// package com.yonyou.nccloud.demo.common;
//
// import org.apache.log4j.Logger;
//
// import com.yonyou.nccloud.sdk.msg.in.event.BatchJob;
// import com.yonyou.nccloud.sdk.msg.in.event.InEnterAgentEvent;
// import com.yonyou.nccloud.sdk.msg.in.event.InFollowEvent;
// import com.yonyou.nccloud.sdk.msg.in.event.InJobEvent;
// import com.yonyou.nccloud.sdk.msg.in.event.InLocationEvent;
// import com.yonyou.nccloud.sdk.msg.in.event.InMenuEvent;
// import com.yonyou.nccloud.sdk.msg.in.event.InQrCodeEvent;
// import com.yonyou.nccloud.sdk.msg.in.event.ScanCodeInfo;
// import com.yonyou.nccloud.weixin.sdk.api.ApiConfig;
// import com.yonyou.nccloud.weixin.sdk.api.ApiResult;
// import com.yonyou.nccloud.weixin.sdk.api.ConBatchApi;
// import com.yonyou.nccloud.weixin.sdk.api.SendMessageApi;
// import com.yonyou.nccloud.weixin.sdk.jfinal.MsgController;
// import com.yonyou.nccloud.weixin.sdk.kit.PropKit;
...
// import com.yonyou.nccloud.weixin.sdk.msg.out.OutImageMsg;
// import com.yonyou.nccloud.weixin.sdk.msg.out.OutNewsMsg;
// import com.yonyou.nccloud.weixin.sdk.msg.out.OutTextMsg;
// import com.yonyou.nccloud.weixin.sdk.msg.out.OutVoiceMsg;
// import com.yonyou.nccloud.weixin.sdk.msg.send.QiYeTextMsg;
// import com.yonyou.nccloud.weixin.sdk.msg.send.Text;
//
/// **
// * 将此 QyWeixinMsgController 在YourJFinalConfig 中注册路由， 并设置好应用中心回调模式中的 URL 与
// token
// * 以及EncodingAESKey，使 URL 指向该 QyWeixinMsgController 继承自父类 MsgController 的
// index
...
// private static final String helpStr = "\t发送 help 可获得帮助，发送 \"美女\" 可看美女
// ，发送新闻可看新版本消息。公众号功能持续完善中";
//
// @Override
...
//
// /**
// * 实现父类抽方法，处理文本消息 本例子中根据消息中的不同文本内容分别做出了不同的响应，同时也是为了测试 jfinal qyweixin
...
// outMsg.addNews("Jfinal qyweixin 发布,JAVA 极速 WEB+ORM 框架", "本星球第一个极速开发框架",
...
// outMsg.addNews("微信公众号", "大家一起来学习交流",
// "http://mmbiz.qpic.cn/mmbiz/zz3Q6WSrzq0fcR8VmNCgugHXv7gVlxI6w95RBlKLdKUTjhOZIHGSWsGvjvHqnBnjIWHsicfcXmXlwOWE6sb39kA/0",
// "http://mp.weixin.qq.com/s?__biz=MzA4MDA2OTA0Mg==&mid=208184833&idx=1&sn=d9e615e45902c3c72db6c24b65c4af3e#rd");
// render(outMsg);
// } else if ("美女".equalsIgnoreCase(msgContent)) {
// OutNewsMsg outMsg = new OutNewsMsg(inTextMsg);
// outMsg.addNews("宝贝更新喽", "宝贝更新喽，我们只看美女 ^_^",
...
// if
// (InFollowEvent.EVENT_INFOLLOW_UNSUBSCRIBE.equals(inFollowEvent.getEvent())) {
