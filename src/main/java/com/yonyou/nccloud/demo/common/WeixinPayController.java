...
import com.yonyou.nccloud.weixin.sdk.api.PaymentApi;
import com.yonyou.nccloud.weixin.sdk.api.PaymentApi.TradeType;
import com.yonyou.nccloud.weixin.sdk.kit.HttpKit;
import com.yonyou.nccloud.weixin.sdk.kit.IpKit;
import com.yonyou.nccloud.weixin.sdk.kit.PaymentKit;
...
public class WeixinPayController {
  ...
  public void index(HttpServletRequest request, HttpServletResponse response) {
    ...
    if (StringUtils.isBlank(return_code) || !"SUCCESS".equals(return_code)) {
      HttpKit.renderText(response, return_msg);
      return;
    }
    ...
    HttpKit.renderText(response, "/jsp/pay.jsp");
  }
  ...
  public void pay_notify(HttpServletRequest request, HttpServletResponse response) {
    ...
    if (PaymentKit.verifyNotify(params, paternerKey)) {
      if (("SUCCESS").equals(result_code)) {
        ...
        HttpKit.renderText(response, PaymentKit.toXml(xml));
        return;
      }
    }
