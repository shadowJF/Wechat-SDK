package com.yonyou.nccloud.weixin.sdk.api.shakearound;
...
import com.yonyou.nccloud.weixin.sdk.api.AccessTokenApi;
import com.yonyou.nccloud.weixin.sdk.api.ApiResult;
import com.yonyou.nccloud.weixin.sdk.api.shakearound.bean.DeviceIdentifier;
...
public class ShakeAroundDeviceApi {
  ...
  private static String applyIdUrl =
   ...
   * @param poiId 
   *        设备关联的门店ID，可为空，关联门店后，在门店1KM的范围内有优先摇出信息的机会。门店相关信息具体可查看：https://mp.weixin.qq.com/zh_CN
   *        /htmledition/comm_htmledition/res/store_manage/store_manage_file.zip
   * @return
   */
  ...
  private static String applyStatusUrl =
      "https://api.weixin.qq.com/shakearound/device/applystatus?access_token=";
  ...
  private static String bindLocationUrl =
   ...
   * @param deviceIdentifier
   * @param poiId 
   *        设备关联的门店ID，关联门店后，在门店1KM的范围内有优先摇出信息的机会。当值为0时，将清除设备已关联的门店ID。门店相关信息具体可查看：https://mp.weixin
   *        .qq.com/zh_CN/htmledition/comm_htmledition/res/store_manage/store_manage_file.zip
   * @return
   */
  ...
  private static String bindPageUrl =
      "https://api.weixin.qq.com/shakearound/device/bindpage?access_token=";

  /**
   * 配置设备与页面的关联关系。配置时传入该设备需要关联的页面的id列表（该设备原有的关联关系将被直接清除）；页面的id列表允许为空，当页面的id列表为空时则会清除该设备的所有关联关系。配置完成后
   * ，在此设备的信号范围内，即可摇出关联的页面信息。 在申请设备ID后，可直接使用接口直接配置页面。 若设备配置多个页面，则随机出现页面信息。一个设备最多可配置30个关联页面。
   * 
  ...
  private static String relationSearchUrl =
      "https://api.weixin.qq.com/shakearound/relation/search?access_token=";
  ...
  private static String groupAddUrl =
      "https://api.weixin.qq.com/shakearound/device/group/add?access_token=";
  ...
  private static String groupUpdateUrl =
      "https://api.weixin.qq.com/shakearound/device/group/update?access_token=";
  ...
  private static String groupDeleteUrl =
      "https://api.weixin.qq.com/shakearound/device/group/delete?access_token=";
  ...
  private static String groupGetListUrl =
      "https://api.weixin.qq.com/shakearound/device/group/getlist?access_token=";
  ...
  private static String groupGetDetailUrl =
      "https://api.weixin.qq.com/shakearound/device/group/getdetail?access_token=";
  ...
  private static String groupAddDeviceUrl =
      "https://api.weixin.qq.com/shakearound/device/group/adddevice?access_token=";
  ...
  private static String groupDeleteDeviceUrl =
      "https://api.weixin.qq.com/shakearound/device/group/deletedevice?access_token=";
   ...
   * @return
   */
  public static ApiResult deleteDeviceFromGroup(int groupId,
