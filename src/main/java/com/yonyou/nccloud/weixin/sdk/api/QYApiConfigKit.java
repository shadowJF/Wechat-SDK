...
import com.yonyou.nccloud.weixin.sdk.cache.DefaultAccessTokenCache;
 ...
 */
public class QYApiConfigKit {

	private static final ThreadLocal<QYApiConfig> tl = new ThreadLocal<QYApiConfig>();
	...
	public static void setThreadLocalApiConfig(QYApiConfig apiConfig) {
		tl.set(apiConfig);
	}
	...
	public static QYApiConfig getApiConfig() {
		QYApiConfig result = tl.get();
		if (result == null)
	...
	public static void setAccessTokenCache(IAccessTokenCache accessTokenCache) {
		QYApiConfigKit.accessTokenCache = accessTokenCache;
	}

	public static IAccessTokenCache getAccessTokenCache() {
		return QYApiConfigKit.accessTokenCache;
	}
