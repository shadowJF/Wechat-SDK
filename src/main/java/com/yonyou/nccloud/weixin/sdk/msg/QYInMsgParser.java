...
import com.yonyou.nccloud.weixin.sdk.msg.in.event.BatchJob;
...
public class QYInMsgParser {
  ...
  private static InMsg parseInVoiceMsgAndInSpeechRecognitionResults(Element root,
      String toUserName, String fromUserName, Integer createTime, String msgType, String agentId) {
  ...
  private static InMsg parseInShortVideoMsg(Element root, String toUserName, String fromUserName,
      Integer createTime, String msgType, String agentId) {
    InShortVideoMsg msg =
        new InShortVideoMsg(toUserName, fromUserName, createTime, msgType, agentId);
    msg.setMediaId(root.elementText("MediaId"));
    msg.setThumbMediaId(root.elementText("ThumbMediaId"));
    msg.setMsgId(root.elementText("MsgId"));
    return msg;
  ...
  private static InMsg parseInEvent(Element root, String toUserName, String fromUserName,
    ...
    if (("subscribe".equalsIgnoreCase(event) || "unsubscribe".equals(event))
    ...
    if ("subscribe".equalsIgnoreCase(event) && StringUtils.isNotBlank(eventKey)
        && eventKey.startsWith("qrscene_")) {
      QYInQrCodeEvent e =
          new QYInQrCodeEvent(toUserName, fromUserName, createTime, msgType, event, agentId);
    ...
    if ("location".equalsIgnoreCase(event)) {
      InLocationEvent e =
          new InLocationEvent(toUserName, fromUserName, createTime, msgType, event, agentId);
    ...
    if ("click".equalsIgnoreCase(event)) {
      InMenuEvent e =
          new InMenuEvent(toUserName, fromUserName, createTime, msgType, event, agentId);
      e.setEventKey(eventKey);
      return e;
    }
    ...
    if ("enter_agent".equalsIgnoreCase(event)) {
      InEnterAgentEvent e =
          new InEnterAgentEvent(toUserName, fromUserName, createTime, msgType, eventKey, agentId);
      e.setEventKey(eventKey);
      return e;
    }
    ...
    if ("batch_job_result".equalsIgnoreCase(event)) {
      InJobEvent e =
          new InJobEvent(toUserName, fromUserName, createTime, msgType, eventKey, agentId);
