...
/**
 * @author Javen 2015年12月19日 管理通讯录>>管理部门
 */
public class QYConDepartmentApi {
	...
	private static String getUrl = "https://qyapi.weixin.qq.com/cgi-bin/department/list";
	   ...
	   * 全量覆盖通讯录部门
	   */
	private final static String replaceparty =
	      "https://qyapi.weixin.qq.com/cgi-bin/batch/replaceparty?access_token=";
	...
	public static ApiResult deleteDepartment(String id) {
		ParaMap pm = ParaMap.create("access_token", AccessTokenApi.getQYAccessTokenStr()).put("id", id);
	 ...
	 * @return
	 */
	public static ApiResult replaceDept(String data) {
		String jsonResult = HttpUtils.post(replaceparty + AccessTokenApi.getQYAccessTokenStr(), data);
		return new ApiResult(jsonResult);
	}
}
