...
public class QYApiConfig {
	...
	public QYApiConfig(String token) {
		setToken(token);
	}
	
	public QYApiConfig(String token, String corpId) {
		setToken(token);
		setCorpId(corpId);
	}
	
	public QYApiConfig(String token, String corpId, boolean messageEncrypt, String encodingAesKey) {
		setToken(token);
		setCorpId(corpId);
