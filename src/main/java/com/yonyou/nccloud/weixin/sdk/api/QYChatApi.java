...
/**
 * @author Javen 2016年1月9日
 * 
 *         企业会话接口
 */
public class QYChatApi {
	// 创建会话
	...
	public static ApiResult Chat(ChatUrl chatUrl, String data) {
		...
		String jsonResult = HttpUtils.post(url + AccessTokenApi.getQYAccessTokenStr(), data);
		return new ApiResult(jsonResult);
	}

	public static ApiResult getChat(String chatid, String data) {
		ParaMap pm = ParaMap.create("access_token", AccessTokenApi.getQYAccessTokenStr()).put("chatid", chatid);
