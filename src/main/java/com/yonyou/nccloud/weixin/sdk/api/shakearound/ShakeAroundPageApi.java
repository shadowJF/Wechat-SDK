...
public class ShakeAroundPageApi {
   ...
   * @return
   */
  public static ApiResult addPage(String title, String pageUrl, String description, String comment,
      String iconUrl) {
  ...
  private static String pageUpdateUrl =
   ...
   * @return
   */
  public static ApiResult updatePage(int pageId, String title, String pageUrl, String description,
      String iconUrl) {
  ...
  private static String pageSearchUrl =
      "https://api.weixin.qq.com/shakearound/page/search?access_token=";

  /**
   * 查询已有的页面，包括在摇一摇页面出现的主标题、副标题、图片和点击进去的超链接。 页面ID查询
   * 
  ...
  /**
   * 查询已有的页面，包括在摇一摇页面出现的主标题、副标题、图片和点击进去的超链接。 批量拉取页面列表。
   * 
  ...
  private static String pageDeleteUrl =
